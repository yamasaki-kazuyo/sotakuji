  ...
  XOFieaturedImageTool = function(parameters) {
    ...
    this.start = function(id) {
      $.ajax({
        type: 'POST',
        url: ajaxurl,
        data: { action: 'xo_featured_image_tools', id: id, 'external_image': parameters.external_image, 'exclude_small_image': parameters.exclude_small_image, 'default_image': parameters.default_image },
